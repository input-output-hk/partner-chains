...
use sidechain_runtime::{
	...
	PalletSessionConfig, RuntimeGenesisConfig, SessionCommitteeManagementConfig, SessionConfig,
...
pub fn testnet_genesis(
	...
	let config = RuntimeGenesisConfig {
		...
		pallet_session: PalletSessionConfig { ..Default::default() },
