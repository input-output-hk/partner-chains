...
* @returns {Uint8Array}
*/
module.exports.apply_params_to_script_no_panic = function(params_bytes, plutus_script_bytes) {
    try {
        ...
        wasm.apply_params_to_script_no_panic(retptr, ptr0, len0, ptr1, len1);
...
const path = require('path').join(__dirname, 'uplc_apply_args_nodejs_bg.wasm');
