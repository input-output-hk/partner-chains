...
if [ "$NUM_REGISTERED_NODES_TO_PROCESS" -eq 0 ]; then
    echo "[LOG] NUM_REGISTERED_NODES_TO_PROCESS is 0. Skipping all registered node key generation, funding, and SPO registration."
else
...
if [ "$NUM_REGISTERED_NODES_TO_PROCESS" -gt 0 ]; then
