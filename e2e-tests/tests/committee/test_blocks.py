...
def test_block_producer_can_update_their_metadata(genesis_utxo, api: BlockchainApi, get_wallet: Wallet):
    ...
    signature = api.sign_block_producer_metadata(genesis_utxo, metadata, skey)
