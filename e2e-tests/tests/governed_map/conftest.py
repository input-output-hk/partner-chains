...
@fixture(scope="class")
def insert_data(static_api: BlockchainApi, genesis_utxo, random_key, random_value, payment_key):
    ...
    yield result
    static_api.partner_chains_node.smart_contracts.governed_map.remove(genesis_utxo, random_key, payment_key)
