...
pub fn raw_permissioned_candidate_data_from(
	...
	let PermissionedCandidateDatumV0 { sidechain_public_key, aura_public_key, grandpa_public_key, im_online_public_key } =
		datum;
	RawPermissionedCandidateData { sidechain_public_key, aura_public_key, grandpa_public_key, im_online_public_key }
}
