...
// --output
// toolkit/native-token-management/pallet/src/weights.rs
// --template
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Storage: `NativeTokenManagement::TransferedThisBlock` (r:1 w:1)
	/// Proof: `NativeTokenManagement::TransferedThisBlock` (`max_values`: Some(1), `max_size`: Some(16), added: 511, mode: `MaxEncodedLen`)
	...
	fn transfer_tokens() -> Weight {
		...
		Weight::from_parts(11_000_000, 1668)
