...
use testcontainers::{Container, GenericImage, runners::SyncRunner};
...
async fn initialize(container: &Container<GenericImage>) -> OgmiosClients {
	let ogmios_port = container.get_host_port_ipv4(1337).unwrap();
