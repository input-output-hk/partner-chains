...
INSERT INTO tx_out ( id, tx_id                 , index, address     , address_raw, address_has_script, payment_cred, stake_address_id, value, data_hash                    , consumed_by_tx_id     )
            VALUES ( 11, init_ics_tx           , 0    , 'ics address', ''         , TRUE              , NULL        , NULL            , 0    , NULL                        , reserve_transfer_tx   ) -- ICS initial utxo 1
                  ...
                  ,( 14, init_ics_tx           , 3    , 'ics address', ''         , TRUE              , NULL        , NULL            , 0    , NULL                        , reserve_transfer_tx   ) -- ICS initial utxo 4
                  ...
                  ,( 31, user_transfer_tx_1    , 0    , 'ics address', ''         , TRUE              , NULL        , NULL            , 0    , user_tranfer_datum_hash_1   , user_transfer_tx_2    ) -- transfers 10 tokens + 100 tokens from previous transaction's utxo
...
VALUES                (1  , 100      , 21        , native_token_id )
