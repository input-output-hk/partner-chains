...
///
/// _Note_: As the code generated by this macro is meant ot be `no_std`-compatible wherever
///         possible, some of the options require that the `alloc` crate be available in the
///         scope where the code is generated.
///
/// # Example
///
/// ```rust
