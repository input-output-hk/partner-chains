...
//! DATE: 2025-10-29, STEPS: `5000`, REPEAT: `2000`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Proof: `BlockProductionLog::CurrentProducer` (`max_values`: Some(1), `max_size`: Some(74), added: 569, mode: `MaxEncodedLen`)
	fn append() -> Weight {
