...
mod tests {
	...
	async fn cli_get_registration_status_returns_correct_json_string() {
		...
		let response = vec![CandidateRegistrationEntry {
			...
			aura_pub_key: aura.to_hex_string(),
			grandpa_pub_key: grandpa.to_hex_string(),
		...
		assert_eq!(
			...
			serde_json::json!([{
				...
				"auraPubKey": "0x90b5ab205c6974c9ea841be688864633dc9ca8a357843eeacf2314649965fe22",
				"grandpaPubKey": "0x439660b36c6c03afafca027b910b4fecf99801834c62a5e6006f27d978de234f",
				"keys": {"aura":"0x90b5ab205c6974c9ea841be688864633dc9ca8a357843eeacf2314649965fe22", "gran":"0x439660b36c6c03afafca027b910b4fecf99801834c62a5e6006f27d978de234f"},
