...
chainspecs:
  ...
  IF [ -d "dev/envs/ci-preview" ]
    ...
    RUN . ./dev/envs/ci-preview/.envrc && partner-chains-node build-spec --chain staging --disable-default-bootnode > ci_preview_chain_spec.json
    SAVE ARTIFACT ci_preview_chain_spec.json AS LOCAL ci_preview_chain_spec.json
  END
  
  # staging-preview
  IF [ -d "dev/envs/staging-preview" ]
    ...
    RUN . ./dev/envs/staging-preview/.envrc && partner-chains-node build-spec --chain staging --disable-default-bootnode > staging_preview_chain_spec.json
    SAVE ARTIFACT staging_preview_chain_spec.json AS LOCAL staging_preview_chain_spec.json
  END
  
  # staging-preprod
  IF [ -d "dev/envs/staging-preprod" ]
    ...
    RUN . ./dev/envs/staging-preprod/.envrc && partner-chains-node build-spec --chain staging --disable-default-bootnode > staging_preprod_chain_spec.json
