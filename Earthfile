...
chainspecs:
  ...
  RUN . ./dev/update-chain-spec.sh devnet_chain_spec.json
  ...
  RUN . ./dev/update-chain-spec.sh ci_preview_chain_spec.json
  ...
  RUN . ./dev/update-chain-spec.sh staging_preview_chain_spec.json
