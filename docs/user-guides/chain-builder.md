...
The partner chain is now ready to start accepting registered validator nodes. [Permissioned candidates](./permissioned.md) and [Registered candidates](./registered.md) have different onboarding processes. Please follow the respective steps for the corresponding type of user.
